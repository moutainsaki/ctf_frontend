...
{selectedCardId !== null && (
  ...
  >
    ...
    >
        {/* モーダルの閉じるボタン */}
        <button
        className="absolute top-4 right-4 text-gray-400 hover:text-gray-600 text-3xl" // サイズを大きく調整
        onClick={handleCloseModal}
      >
        ×
      </button>
      ...
      <div className="flex items-center space-x-6 mb-4">
        ...
        <p className="text-2xl text-gray-700 text-left">Kubemetesの中にpod大量発生！！！！</p>
      </div>
